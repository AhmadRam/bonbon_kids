    ...
    'seeders' => [
        ...
        'shop' => [
            'theme-customizations' => [
                'bold-collections' => [
                    'content' => [
                        'btn-title' => 'استكشف الهدايا',
                        'description' => 'اعثر على الهدية المثالية لكل مناسبة! من أعياد الميلاد إلى الإنجازات، مجموعتنا المختارة من الألعاب سترسم البسمة على وجه أي طفل. فلنجعل كل لحظة لا تُنسى!',
                        'title' => 'أفكار رائعة للهدايا لكل مناسبة',
                    ],
                ...
                'social-section' => [
                    'name' => 'تابع المرح! #toysrus',
                    'content' => [
                        'title' => 'تابع المرح! #toysrus',
                        'sub-title' => 'منشن لنا في صورك لتحصل على فرصة للظهور على صفحتنا!',
                    ],
                ],

                'shop-by-brand' => [
                    'name' => 'تسوق حسب العلامة التجارية',
                    'title' => 'علامات الألعاب المفضلة',
                ],
                ...
                'game-container' => [
                    'content' => [
                        'sub-title-1' => 'لعب تفاعلي',
                        'sub-title-2' => 'مجموعات إبداعية',
                        'title' => 'العب وتعلم مع أحدث اختياراتنا!',
                    ],
                ...
                'top-collections' => [
                    'content' => [
                        'sub-title-1' => 'اختياراتنا',
                        'sub-title-2' => 'اختياراتنا',
                        'sub-title-3' => 'اختياراتنا',
                        'sub-title-4' => 'اختياراتنا',
                        'sub-title-5' => 'اختياراتنا',
                        'sub-title-6' => 'اختياراتنا',
                        'title' => 'تسوق حسب العمر!',
                    ],
