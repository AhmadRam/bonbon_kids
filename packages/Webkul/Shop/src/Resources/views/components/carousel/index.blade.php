...
@pushOnce('scripts')
    ...
    >
        <div class="relative m-auto flex w-full overflow-hidden">
            ...
            <!-- Navigation -->
            <span
                class="icon-arrow-left rtl:icon-arrow-right absolute ltr:left-2.5 rtl:right-2.5 top-1/2 -mt-[22px] hidden w-auto rounded-full bg-black/80 p-3 text-2xl font-bold text-white opacity-30 transition-all md:inline-block"
                :class="{
            ...
            <span
                class="icon-arrow-right rtl:icon-arrow-left absolute ltr:right-2.5 rtl:left-2.5 top-1/2 -mt-[22px] hidden w-auto rounded-full bg-black/80 p-3 text-2xl font-bold text-white opacity-30 transition-all md:inline-block"
                :class="{
