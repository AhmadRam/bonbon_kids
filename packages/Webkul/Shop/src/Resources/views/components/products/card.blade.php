...
@pushOnce('scripts')
    ...
    >
        ...
        >
            ...
            <div class="-mt-9 grid max-w-[291px] translate-y-9 content-start gap-2.5 bg-white p-2.5 transition-transform duration-300 ease-out group-hover:-translate-y-0 group-hover:rounded-t-lg max-md:relative max-md:mt-0 max-md:translate-y-0 max-sm:min-w-[170px] max-sm:max-w-[192px]">
                    ...
                    @if (core()->getConfigData('sales.checkout.shopping_cart.cart_page'))
                        ...
                        <div class="flex w-full flex-col gap-2">
                            ...
                            <a
                                ...
                                target="_blank"
                                class="flex w-full items-center justify-center gap-1 rounded-[10px] py-[10px] px-2 text-sm font-semibold text-white transition-all hover:opacity-90 max-sm:rounded-xl max-sm:p-2"
