    ...
    <div class="mt-4 rounded-xl bg-[#F0FDF4] p-4 border border-[#BBF7D0] text-right shadow-sm flex flex-col gap-3">
        <div class="flex items-start gap-2">
            ...
            <p class="text-sm text-[#166534] leading-relaxed">
                <strong>يوجد تغليف مجاني!</strong><br>
                لاختيار لون التغليف (أزرق أو زهري)، يرجى التواصل معنا عبر الواتساب.
            </p>
        </div>
        <a href="https://wa.me/+96592214430?text=مرحباً، أود اختيار لون التغليف لطلبي. اللون المفضل هو:" target="_blank" class="inline-flex items-center justify-center gap-2 rounded-lg bg-[#25D366] px-4 py-2.5 text-sm font-medium text-white transition-all hover:bg-[#128C7E] shadow-sm mt-1 w-full sm:w-auto sm:self-end">
