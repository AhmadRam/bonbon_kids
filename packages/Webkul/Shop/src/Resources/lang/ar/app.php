...
return [
            ...
            'orders' => [
                ...
                'view' => [
                    ...
                    'information' => [
                        ...
                        'item-shipped' => 'تم التوصيل (:qty_shipped)',
                        'item-status' => 'حالة العنصر',
                        'ordered-item' => 'تم الطلب (:qty_ordered)',
                        'placed-on' => 'تم الطلب في',
                        'price' => 'السعر',
                        'product-name' => 'الاسم',
                        'shipping-handling' => 'التوصيل والتسليم',
                        'shipping-handling-excl-tax' => 'التوصيل والتسليم (باستثناء الضريبة)',
                        'shipping-handling-incl-tax' => 'التوصيل والتسليم (شامل الضريبة)',
                        'sku' => 'رمز المنتج',
                        'subtotal' => 'المجموع الفرعي',
                ...
                'invoice-pdf' => [
                    ...
                    'qty' => 'الكمية',
                    'ship-to' => 'التوصيل إلى',
                    'shipping-handling-excl-tax' => 'تكلفة التوصيل (بدون ضريبة)',
                    'shipping-handling-incl-tax' => 'تكلفة التوصيل (شامل الضريبة)',
                    'shipping-handling' => 'تكلفة التوصيل',
            ...
            'header' => [
                'desktop' => [
                    ...
                    'bottom' => [
                        ...
                        'shop-by-age' => 'تسوق من خلال العمر',
    ...
    'checkout' => [
        'success' => [
            'info' => 'سنقوم بإرسال تفاصيل طلبك ومعلومات التتبع إلى رقم هاتفك',
        ...
        'cart' => [
            ...
            'specify-shipping-method' => 'يرجى تحديد طريقة التوصيل.',
            ...
            'summary' => [
                ...
                'grand-total' => 'المجموع الكلي',
                'free-gift-wrapping'           => 'يوجد تغليف مجاني!',
                'gift-wrapping-desc'           => 'لاختيار لون التغليف (أزرق أو زهري)، يرجى التواصل معنا عبر الواتساب.',
                'contact-whatsapp'             => 'تواصل عبر واتساب',
                'whatsapp-msg'                 => 'مرحباً، أود اختيار لون التغليف لطلبي. اللون المفضل هو:',
        ...
        'onepage' => [
            'address' => [
                ...
                'postcode' => 'الرمز البريدي',
                'proceed' => 'المتابعة',
                'same-as-billing' => 'استخدم نفس العنوان للتوصيل؟',
                'save' => 'حفظ',
                ...
                'floor'          => 'دور',
                'apartment'      => 'شقة',
                'notes'          => 'ملاحظات (علامة مميزة)',
                'title'          => 'بيانات العميل',
                'vat-id'         => 'رقم الضريبة',
                'full-address'   => 'العنوان بالكامل (اختياري)',
                'full-address-placeholder' => 'أدخل العنوان بالتفصيل إذا رغبت (المنطقة، الشارع، رقم المنزل/الشقة...)' ,
            ],
    ...
    'emails' => [
        ...
        'orders' => [
            ...
            'shipped' => [
                'greeting' => 'تم توصيل طلبك :order_id المنجز في :created_at',
                'subject' => 'تأكيد توصيل جديد',
                'summary' => 'ملخص التوصيل',
            ...
            'shipping-address' => 'عنوان التوصيل',
            'shipping-handling' => 'التوصيل والتسليم',
            'shipping-handling-excl-tax' => 'التوصيل والتسليم (بدون ضريبة)',
            'shipping-handling-incl-tax' => 'التوصيل والتسليم (شامل الضريبة)',
            'sku' => 'رمز المنتج',
            'subtotal' => 'المجموع الفرعي',
            'subtotal-excl-tax' => 'المجموع الفرعي (بدون ضريبة)',
