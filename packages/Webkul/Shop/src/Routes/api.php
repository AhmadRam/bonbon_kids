...
Route::group(['prefix' => 'api'], function () {
    ...
    Route::controller(ProductController::class)->prefix('products')->group(function () {
        ...
        Route::get('{id}/same-category', 'sameCategoryProducts')->name('shop.api.products.same-category.index');

        Route::get('cart-category', 'cartCategoryProducts')->name('shop.api.products.cart-category.index');
    });
